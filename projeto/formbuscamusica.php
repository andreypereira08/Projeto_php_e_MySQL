    ...
    <div class="container">
      ...
      <div id="my-nav" class="collapse navbar-collapse">
		...
		<div class="container-fluid fh5co-recent-work" style="height: 100vh;">
								...
								<div class="container">
								<h1>Configuração | Música</h1>
									<?php
									
									 echo "<form action='paginaalteraMusica.php' method='POST'>";
									
									 echo "<div class='form-group'>";
									 echo "<label>Pesquisar música cadastrada:</label>";
									
									 echo "<select name='pesquisa' class='form-control' style='width:300px'>";
									
									include("conexao.php");
									
									$sql="SELECT nome_mus, cod_mus FROM musica";
									$resultado=mysqli_query($conexao, $sql);
									if (mysqli_num_rows($resultado) >0){
										while($row = mysqli_fetch_array($resultado)){
											// echo $row['nome'];
									echo "<option value='".$row['cod_mus']."'>".$row['nome_mus']."</option>";
									}
									}
									 echo "</select>"; 
																?>
												  <br>
												  O que deseja fazer com a música selecionada?
												  <br>
